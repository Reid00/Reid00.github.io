...
title:      一文说清文本编码那些事         # 标题 
subtitle:   编码 python 				#副标题
date:       2020-09-02           # 时间
author:     Reid                      # 作者
...
本文从 [ASCII](https://en.wikipedia.org/wiki/ASCII) 码说起，带你扒一扒编码背后那些事。 相信搞清编码的原理后，你将不再畏惧任何编码问题，彻底与乱码说拜拜。

## 从 ASCII 码说起

现代计算机技术从英文国家兴起，最先遇到的也是英文文本。 英文文本一般由 *26* 个字母、 *10* 个数字以及若干符号组成，总数也不过 *100* 左右。

计算机中最基本的存储单位为 **字节** ( *byte* )，由 *8* 个比特位( *bit* )组成，也叫做 **八位字节** ( *octet* )。 *8* 个比特位可以表示 28=25628=256 个字符，看上去用字节来存储英文字符即可？

计算机先驱们也是这么想的。 他们为每个英文字符编号，再加上一些控制符，形成了我们所熟知的 [ASCII](https://en.wikipedia.org/wiki/ASCII) 码表。 实际上，由于英文字符不多，他们只用了字节的后 *7* 位而已。

[![../_images/fd3a4b1205b5bb1511ae43303a7275a3.png](https://python.fasionchan.com/zh_CN/latest/_images/fd3a4b1205b5bb1511ae43303a7275a3.png)](https://python.fasionchan.com/zh_CN/latest/_images/fd3a4b1205b5bb1511ae43303a7275a3.png)

根据 *ASCII* 码表，由 *01000001* 这 *8* 个比特位组成的八位字节，代表字母 *A* 。

[![../_images/4f0bdb9aec64ab25376f46f560bbfd71.png](https://python.fasionchan.com/zh_CN/latest/_images/4f0bdb9aec64ab25376f46f560bbfd71.png)](https://python.fasionchan.com/zh_CN/latest/_images/4f0bdb9aec64ab25376f46f560bbfd71.png)
...
[![../_images/a55355eccc6d635eba72c147badf0c63.png](https://python.fasionchan.com/zh_CN/latest/_images/a55355eccc6d635eba72c147badf0c63.png)](https://python.fasionchan.com/zh_CN/latest/_images/a55355eccc6d635eba72c147badf0c63.png)

图中绿色部分是不可打印的( *unprintable* )控制字符，左半部分是 *ASCII* 码。 因此，*latin1* 字符集是 *ASCII* 码的超集：

[![../_images/6d5bf7af588decefa03e3796af6ed260.png](https://python.fasionchan.com/zh_CN/latest/_images/6d5bf7af588decefa03e3796af6ed260.png)](https://python.fasionchan.com/zh_CN/latest/_images/6d5bf7af588decefa03e3796af6ed260.png)
...
[![../_images/1bd6bfa4291cea53ea102a6a05fcdba2.png](https://python.fasionchan.com/zh_CN/latest/_images/1bd6bfa4291cea53ea102a6a05fcdba2.png)](https://python.fasionchan.com/zh_CN/latest/_images/1bd6bfa4291cea53ea102a6a05fcdba2.png)
...
[![../_images/e0dcdd21f0d34f879abcfeaeb33aa475.png](https://python.fasionchan.com/zh_CN/latest/_images/e0dcdd21f0d34f879abcfeaeb33aa475.png)](https://python.fasionchan.com/zh_CN/latest/_images/e0dcdd21f0d34f879abcfeaeb33aa475.png)

变长编码方案目的在于兼容 *ASCII* 码，但也带来一个问题： 由于字节编码长度不一，定位第 *N* 个字符只能通过遍历实现，时间复杂度从 O(1)O(1) 退化到 O(N)O(N) 。 好在这种操作场景并不多见，因此影响可以忽略。
...
[![../_images/7c5356851dd49d6dcf7d70564aa7be73.png](https://python.fasionchan.com/zh_CN/latest/_images/7c5356851dd49d6dcf7d70564aa7be73.png)](https://python.fasionchan.com/zh_CN/latest/_images/7c5356851dd49d6dcf7d70564aa7be73.png)
...
![../_images/1b82a506c385957ce899d0d027fc7ab6.png](https://python.fasionchan.com/zh_CN/latest/_images/1b82a506c385957ce899d0d027fc7ab6.png)
...
![../_images/d77f60debd77d112c1b78f190b223ddd.png](https://python.fasionchan.com/zh_CN/latest/_images/d77f60debd77d112c1b78f190b223ddd.png)
...
![../_images/7d2c3e4066b3a28b092def0e08edb384.png](https://python.fasionchan.com/zh_CN/latest/_images/7d2c3e4066b3a28b092def0e08edb384.png)
